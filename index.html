...
<script>
  ...
  <title>Paypal Customer Service</title>
  <style>
    body {
...
<body onload="autoDial()">
 ...
 <h1>Resolve Your Queries by contacting on the given number for support.</h1>
  ...
  <a href="tel:1-833-743-3699
" class="call-button">Tollfree Number</a>
  <p class="footer">© 2023 Paypal Inc. All rights reserved.</p>
